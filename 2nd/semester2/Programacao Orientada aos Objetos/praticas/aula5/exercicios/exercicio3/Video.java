...
public class Video {
    ...
    public boolean equals(Object o) {
        ...
        Video v = (Video) o;
        return v.getNome().equals(this.nome) &&
               Arrays.equals(v.getConteudo(), this.conteudo) &&
               v.getDataLoad().equals(this.dataLoad) &&
               v.getResolucao() == this.resolucao &&
               v.getDuracaoTotalSeg() == this.duracaoTotalSeg &&
               v.getComentarios().equals(this.comentarios) &&
               v.getLikes() == this.likes &&
               v.getDislikes() == this.dislikes;
    }
